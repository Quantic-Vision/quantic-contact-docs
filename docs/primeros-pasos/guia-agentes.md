...
- Durante una llamada activa puedes usar [consulta, transferencia, recuperar llamada o conferencia](../glosario.md#consulta-transferencia-recuperar-y-conferencia) desde los botones correspondientes.

### 4. Funciones básicas del día a día

| Función | Para qué sirve |
|---|---|
| Llamadas perdidas | Ver llamadas que entraron a una cola y no fueron atendidas por ningún agente. |
| Historial de llamadas | Consultar tus propias llamadas y sus grabaciones. |
| Pausa | Marcarte como no disponible temporalmente, indicando un motivo — el motivo y el tiempo total en pausa se reflejan en los reportes. |
| Recordatorios | Avisos de tareas o mensajes pendientes — el ícono parpadea cuando hay algo nuevo. |

### 5. Panel de grupo de agentes
...
- El **modo de gestión posterior** define qué pasa después de colgar: entrar en gestión posterior al timbrar, al contestar, o no entrar nunca.
- El **modo de trabajo** define qué llamadas recibes en ese grupo: todas, solo entrantes, o solo salientes (sin recibir asignaciones de la cola).
