...
!!! warning "Contenido con partes desactualizadas"
    Tres de los cuatro artículos de esta sección documentan procedimientos de infraestructura de 2018 (OpenVPN, APC, Mailman) que ya no aplican tal cual sobre la instalación actual (Rocky Linux 9 / PHP 7.4). Cada artículo indica específicamente qué cambió.
