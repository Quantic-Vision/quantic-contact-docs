...
![Listado de servicios de atención al cliente en el menú del sistema, con el servicio "Customer Service" ya creado](../assets/images/atencion-cliente-mensajeria-ecommerce/servicios-atencion-cliente-listado.jpg)

![Formulario para agregar un servicio de atención al cliente: nombre, grupo de agentes, enlace de trabajo, e-commerce asociado y prioridad de tipo de cliente](../assets/images/atencion-cliente-mensajeria-ecommerce/agregar-servicio-atencion-cliente.jpg)
...
![Listado de motivos de llamada configurados, con su equipo, nota y work order asociado](../assets/images/atencion-cliente-mensajeria-ecommerce/motivos-llamada-listado.jpg)

![Formulario para agregar un motivo de llamada: nombre, estado (respondida/no respondida), equipo y work order asociado](../assets/images/atencion-cliente-mensajeria-ecommerce/agregar-motivo-llamada.jpg)
...
![Pantalla de registro de llamadas (CDR) de atención al cliente con filtros de búsqueda por origen, destino, resultado de llamada y duración](../assets/images/atencion-cliente-mensajeria-ecommerce/registro-llamadas-atencion-cliente.jpg)
...
![Pantalla de búsqueda de clientes del agente, con selector de tipo de cliente (individual/institucional) y campo de búsqueda por teléfono o nombre](../assets/images/atencion-cliente-mensajeria-ecommerce/busqueda-clientes-agente.jpg)
...
![Listado de llamadas perdidas con origen, destino, cliente, fecha y columna "Visit" indicando si ya fue devuelta](../assets/images/atencion-cliente-mensajeria-ecommerce/llamadas-perdidas-listado.jpg)
...
- **Cliente individual / institucional:** dos tipos de ficha de cliente en el sistema, cada una con sus propios campos personalizados y etiquetas. Comparten el mismo origen de datos que usan atención al cliente y campañas salientes — importación masiva, alta manual desde la pantalla de gestión de clientes, o alta desde la pantalla emergente de atención al cliente/campaña.
  ...
  ![Listado de clientes individuales con filtros de búsqueda, etiquetas de cliente, paquetes y asignación por región](../assets/images/atencion-cliente-mensajeria-ecommerce/clientes-individuales-listado.jpg)
...
![Listado de campos personalizados con tabla, tipo, idioma, identificador y si están seleccionados](../assets/images/atencion-cliente-mensajeria-ecommerce/campos-personalizados-listado.jpg)
...
![Formulario para agregar un campo personalizado: equipo, tabla, tipo, identificador, paquete de clientes e idioma](../assets/images/atencion-cliente-mensajeria-ecommerce/agregar-campo-personalizado.jpg)

![Ejemplo de campo personalizado tipo "relate" con selectores en cascada de provincia, ciudad, distrito y oficina](../assets/images/atencion-cliente-mensajeria-ecommerce/campo-personalizado-tipo-relacion.jpg)
...
![Diálogo para agregar una etiqueta de cliente, con selector de equipo y campo de nombre de la etiqueta](../assets/images/atencion-cliente-mensajeria-ecommerce/agregar-etiqueta-cliente.jpg)
...
- **Campos especiales — cliente individual:** *edad/fecha de nacimiento* se calculan automáticamente uno a partir del otro; *lista negra* = "sí" agrega automáticamente todos los teléfonos del cliente al listado de números bloqueados de PBX avanzado → lista negra de entrantes (se recomienda documentar el motivo en un campo personalizado dedicado); *institución asociada* vincula el cliente individual a una institución del mismo equipo.
  ...
  ![Campo "lista negra" en la ficha del cliente individual, con memo del motivo del bloqueo](../assets/images/atencion-cliente-mensajeria-ecommerce/campo-lista-negra-cliente.jpg)

  ![Campo de etiquetas en la ficha del cliente, mostrando la etiqueta "new customer" ya asignada y el botón para agregar más](../assets/images/atencion-cliente-mensajeria-ecommerce/campo-etiquetas-cliente.jpg)
...
![Formulario para agregar un catálogo de e-commerce: nombre, equipo, estado y memo](../assets/images/atencion-cliente-mensajeria-ecommerce/agregar-catalogo-ecommerce.jpg)
...
![Formulario para agregar un producto: nombre, tipo, categoría, código de barras, precio, precio de socio y vigencia](../assets/images/atencion-cliente-mensajeria-ecommerce/agregar-producto.jpg)
...
![Pestaña "Información básica" de un pedido, con código, cliente, estado, precio y fechas](../assets/images/atencion-cliente-mensajeria-ecommerce/pedido-informacion-basica.jpg)

![Pestaña "Productos comprados" de un pedido, con el detalle de línea por producto: cantidad, precio unitario y monto a cobrar](../assets/images/atencion-cliente-mensajeria-ecommerce/pedido-productos-comprados.jpg)
